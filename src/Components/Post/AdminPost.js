...
const data = {
  ...
  //  }
   ...
   function AdminPost({post,deleteitem,posttothepost,more}){
            ...
            return (<Parallax data={data}>
              <div className="container-post">
                ...
                <h3>{postitems.heading}</h3>
                  ...
                  <button type="submit" className="delete" name="id" value={postitems._id} onClick={deleteitem}>DELETE</button>
                </div>
                <hr style={{
...
export default connect(mapToStatetoProps,mapToDispatchtoProps)(AdminPost);